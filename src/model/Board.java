 ...
 * 
 * @author Alan Fowler
 * @author Jonah Howard - made various additions 
 * @version Autumn 2015
 */
public final class Board extends Observable {
    ...
    public void hardDrop() {
        int count = 0;  // Track how many pieces the current piece moved down
        while (isMoveDownLegal()) {
            myCurrentPiece.moveDown();
            count++;
        }
        freeze(); // this will notify observers
        // Notify the observers of how many lines the current piece moved down
        setChanged();
